...
python py2so.py -l ~/anaconda3/include/python3.6m -d ~/Downloads/Gastroscope/Client -o ~/Gastroscope/Client -m ManageClient.py,__init__.py -D ui,proto,spect -k $KEEP
